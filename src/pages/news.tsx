  ...
  return (
    <section className={classes.news}>
      <article className={classes.container}>
          ...
          <div className={classes.wrapper}>
            <div className={classes.button}>
              <a
                ...
                <svg xmlns="http://www.w3.org/2000/svg" aria-labelledby="at6my08iontd0xrqd2vtemfq49u5d2ap" role="img" width={18} height={18} viewBox="0 0 24 24" fill="icon fill-current #fff">
            ...
            <div className={classes.button}>
              <a itemProp='url'
                ...
                target='_blank'className={classes.icon} rel="noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" width={18} height={18} aria-labelledby="amwlxxy6d7ag5od3qgka1ldrzrdbkz82" role="img" viewBox="0 0 24 24" fill="icon fill-current #fff">
        ...
        <p itemProp='text' className={classes.paragraph}>{content}</p>
      </article>
